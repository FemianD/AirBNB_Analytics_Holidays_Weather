...
class(holiday_NL)
holiday_NL<-holiday_NL %>% as.data.frame()
class(holiday_NL)
...
summary(holiday_FR)
class(holiday_FR)
holiday_FR<-holiday_FR %>% as.data.frame()
class(holiday_FR)
...
summary(holiday_GB)
class(holiday_GB)
holiday_GB<-holiday_GB %>% as.data.frame()
class(holiday_GB)
...
summary(holiday_IE)
class(holiday_IE)
holiday_IE<-holiday_IE %>% as.data.frame()
class(holiday_IE)
...
summary(holiday_ES)
class(holiday_ES)
holiday_ES<-holiday_ES %>% as.data.frame()
class(holiday_ES)
...
summary(holiday_AT)
class(holiday_AT)
holiday_AT<-holiday_AT %>% as.data.frame()
class(holiday_AT)
...
summary(holiday_PT)
class(holiday_PT)
holiday_PT<-holiday_PT %>% as.data.frame()
class(holiday_PT)
...
summary(holiday_DE)
class(holiday_DE)
holiday_DE<-holiday_DE %>% as.data.frame()
class(holiday_DE)
...
summary(holiday_CZ)
class(holiday_CZ)
holiday_CZ<-holiday_CZ %>% as.data.frame()
class(holiday_CZ)
...
summary(holiday_BE)
class(holiday_BE)
holiday_BE<-holiday_BE %>% as.data.frame()
class(holiday_BE)
...
summary(holiday_GR)
class(holiday_GR)
holiday_GR<-holiday_GR %>% as.data.frame()
class(holiday_GR)
...
summary(holiday_DK)
class(holiday_DK)
holiday_DK<-holiday_DK %>% as.data.frame()
class(holiday_DK)
...
summary(holiday_NO)
class(holiday_NO)
holiday_NO<-holiday_NO %>% as.data.frame()
class(holiday_NO)
...
summary(holiday_SE)
class(holiday_SE)
holiday_SE<-holiday_SE %>% as.data.frame()
class(holiday_SE)
...
summary(holiday_LV)
class(holiday_LV)
holiday_LV<-holiday_LV %>% as.data.frame()
class(holiday_LV)
